...
if __name__=="__main__":    
    ...
    print ('loading data...')
    train, valid, word_vocab, char_vocab = build_dataset(data_folder)
    ...
    pickle.dump([train, valid, word_vocab, char_vocab, Embed_word, word2id, Embed_char, char2id], open('matching_dataset.pkl', 'wb'))
